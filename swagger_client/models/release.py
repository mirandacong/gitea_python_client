...
class Release(object):
    ...
    def __init__(self, assets=None, author=None, body=None, created_at=None, draft=None, id=None, name=None, prerelease=None, published_at=None, tag_name=None, tarball_url=None, target_commitish=None, url=None, zipball_url=None):  # noqa: E501
