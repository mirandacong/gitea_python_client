...
class MiscellaneousApi(object):
    ...
    def render_markdown(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.render_markdown(async=True)
        >>> result = thread.get()
    ...
    def render_markdown_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.render_markdown_with_http_info(async=True)
        >>> result = thread.get()
    ...
    def render_markdown_raw(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.render_markdown_raw(body, async=True)
        >>> result = thread.get()
    ...
    def render_markdown_raw_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.render_markdown_raw_with_http_info(body, async=True)
        >>> result = thread.get()
